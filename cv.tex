...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
 ...
 Specializing in Computer Vision for Robotics and ROS Development & Mobile: +91 7984081876 \\
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Sastra Robotics}{Gandhinagar, India}
      {Computer Vision Intern}{September 2024 -- Present}
      \resumeItemListStart
        \resumeItem{Computer Vision and Grasping techniques}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Computer Vision and 3D Reconstruction}
          {Developed pipelines for Pose Estimation 3D reconstruction analysis projects under \href{https://www.iitgn.ac.in/faculty/me/6-harish}{Prof Harish PM}.}
      \resumeItemListEnd
...
\section{Projects}
  ...
  \resumeSubItem{\href{https://github.com/Kaivalya192/Object-Property-Detection}{Object Physical Property Detection}}
      {Recognize an object and determine its physical properties by vLLM and Ollama, such as material, surface friction, dimensions, and approximate weight, to set initial parameters for a gripper.}
...
\resumeSubHeadingListStart
   ...
   \item{
     ...
     \textbf{Tools:} Docker, Conda, Git, Ollama
   }
   \item{
